...
class ExpenseServiceTest {
        ...
        void readExpenses_returnsMappedModels() {
                var input = new ReadListInput("101", LocalDate.of(2025, 2, 1), LocalDate.of(2025, 2, 28), null, null);
                ...
                verify(specFactory).hasTransactionDateBetween(eq(input.startDate()), eq(input.endDate()),
                                eq(ExpenseEntity.class));
